...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.MyHolder> {
    ...
    fragment_search context;
    ArrayList<BookDomain> arrayList;
    private ArrayList<BookDomain> originalList;
    private ArrayList<BookDomain> filteredList;
    LayoutInflater layoutInflater;

    public SearchAdapter(fragment_search context, ArrayList<BookDomain> arrayList) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        BookDomain currentFood = filteredList.get(position);
        ...
        holder.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (position != RecyclerView.NO_POSITION && position < filteredList.size()) {
                    BookDomain selectedFood = filteredList.get(position);
    ...
    public void filter(String query) {
        ...
        if (query.isEmpty()) {
            ...
            for (BookDomain food : originalList) {
